...
export default function Sidebar() {
    // For now, show all menu items (no role-based filtering without AuthProvider)
    // In production, you can add role checks from your own auth system
